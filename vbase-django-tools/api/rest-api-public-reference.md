...
<h1 id="vbase-api-system">system</h1>

## system_portfolios_list

<a id="opIdsystem_portfolios_list"></a>

### Code samples

```shell
# You can also use wget
curl -X GET https://app.vbase.com/api/v1/system/portfolios \
  -H 'Authorization: API_KEY'

```

`GET /system/portfolios`

Get all portfolios or a single portfolio by symbol.

<h3 id="system_portfolios_list-responses">Responses</h3>
...
## system_portfolios_read

<a id="opIdsystem_portfolios_read"></a>

### Code samples

```shell
# You can also use wget
curl -X GET https://app.vbase.com/api/v1/system/portfolios/{portfolio_symbol} \
  -H 'Authorization: API_KEY'

```

`GET /system/portfolios/{portfolio_symbol}`

Get all portfolios or a single portfolio by symbol.

<h3 id="system_portfolios_read-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|portfolio_symbol|path|string|true|none|

<h3 id="system_portfolios_read-responses">Responses</h3>
